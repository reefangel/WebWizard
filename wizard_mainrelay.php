...
$( function() {
	...
	$('#next').button({
	  ...
	  iconPosition: "end"
		...
		window.location.href = "wizard_mainrelay_ports.php?port=1";
	});
	$( "input" ).checkboxradio({
      icon: false
    });
...
<div id="main" class="split split-horizontal">
    ...
    <h2>Main Relay Box</h2>
	<p>On the following 8 steps, we are going to be assigning a function for each port on the main relay box.</p>
    <p>Each port number is identified on the picture below.</p>
	<p><img src="image/relay_small.png"></p>
    <div id=footer>
