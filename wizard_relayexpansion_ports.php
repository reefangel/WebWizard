...
<script>
$( function() {
	$('#LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>').button();
	...
	$('#prev').button({
	  icon: "ui-icon-triangle-1-w"
		...
		save_settings();
		window.location.href = "<?php if ($_GET['port']==1) echo 'wizard_relayexpansion.php?box=1'; else if ($_GET['port']==11) echo 'wizard_relayexpansion.php?box=2'; else echo 'wizard_relayexpansion_ports.php?port='.($_GET['port']-1).'&box='.($_GET['box']); ?>";
	});
	$('#next').button({
	  ...
	  iconPosition: "end"
		...
		save_settings();
		window.location.href = "<?php if ($_GET['port']==8) echo 'wizard_relayexpansion.php?box=2'; elseif ($_GET['port']==18) echo 'wizard_standarddimming.php'; else echo 'wizard_relayexpansion_ports.php?port='.($_GET['port']+1).'&box='.($_GET['box']); ?>";
	});
...
function save_settings(){
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_function",$("input[name=function]:radio:checked").attr('id'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnon",$('#timeschedule_turnon').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnoff",$('#timeschedule_turnoff').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_delayed",$('#timeschedule_delayed').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnon",$('#heater_turnon').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnoff",$('#heater_turnoff').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnon",$('#chiller_turnon').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnoff",$('#chiller_turnoff').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_settings",$('input[name=topoff_settings]:radio:checked').attr('id'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_timeoput",$('#topoff_timeoput').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_lowlevel",$('#topoff_lowlevel').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_highlevel",$('#topoff_highlevel').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_settings",$('input[name=wavemaker_settings]:radio:checked').attr('id'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer1",$('#wavemaker_timer1').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer2",$('#wavemaker_timer2').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnon",$('#co2_turnon').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnoff",$('#co2_turnoff').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnon",$('#ph_turnon').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnoff",$('#ph_turnoff').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_every",$('#dosing_every').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_for",$('#dosing_for').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_offset",$('#dosing_offset').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_delayed_start",$('#delayed_start').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_opposite_port",$('#opposite_port').val());
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_feeding_override", $('#feeding_override').prop('checked'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_waterchange_override", $('#waterchange_override').prop('checked'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_overheat_override", $('#overheat_override').prop('checked'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_leak_override", $('#leak_override').prop('checked'));
	localStorage.setItem("expansion_port_<?php echo $_GET['port']; ?>_lightson_override", $('#lightson_override').prop('checked'));
	localStorage.setItem("LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>", $('#LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>').val());
 }

function load_settings(){
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_function")!==null)
	{
		$("input[name=function]").prop("checked",false).checkboxradio("refresh")
		$("#"+localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_function")).prop("checked",true).checkboxradio("refresh");
		$("#"+localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_function")+"_options").show();
	}
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnon")!==null)
		$('#timeschedule_turnon').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnon"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnoff")!==null)
		$('#timeschedule_turnoff').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_turnoff"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_delayed")!==null)
		$('#timeschedule_delayed').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_timeschedule_delayed"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnon")!==null)
		$('#heater_turnon').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnon"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnoff")!==null)
		$('#heater_turnoff').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_heater_turnoff"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnon")!==null)
		$('#chiller_turnon').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnon"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnoff")!==null)
		$('#chiller_turnoff').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_chiller_turnoff"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_settings")!==null)
	{
		$("input[name=topoff_settings]").prop("checked",false).checkboxradio("refresh")
		$("#"+localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_settings")).prop("checked",true).checkboxradio("refresh");
	}
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_timeoput")!==null)
		$('#topoff_timeoput').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_timeoput"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_lowlevel")!==null)
		$('#topoff_lowlevel').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_lowlevel"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_highlevel")!==null)
		$('#topoff_highlevel').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_topoff_highlevel"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_settings")!==null)
	{
		$("input[name=wavemaker_settings]").prop("checked",false).checkboxradio("refresh")
		$("#"+localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_settings")).prop("checked",true).checkboxradio("refresh").click();
	}
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer1")!==null)
		$('#wavemaker_timer1').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer1"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer2")!==null)
		$('#wavemaker_timer2').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_wavemaker_timer2"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnon")!==null)
		$('#co2_turnon').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnon"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnoff")!==null)
		$('#co2_turnoff').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_co2_turnoff"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnon")!==null)
		$('#ph_turnon').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnon"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnoff")!==null)
		$('#ph_turnoff').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_ph_turnoff"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_every")!==null)
		$('#dosing_every').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_every"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_for")!==null)
		$('#dosing_for').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_for"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_offset")!==null)
		$('#dosing_offset').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_dosing_offset"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_delayed_start")!==null)
		$('#delayed_start').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_delayed_start"));
	if (localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_opposite_port")!==null)
		$('#opposite_port').val(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_opposite_port"));
	if(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_feeding_override")=="true")
		$('#feeding_override').prop('checked',true).checkboxradio( "refresh" );
	if(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_waterchange_override")=="true")
		$('#waterchange_override').prop('checked',true).checkboxradio( "refresh" );
	if(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_overheat_override")=="true")
		$('#overheat_override').prop('checked',true).checkboxradio( "refresh" );
	if(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_leak_override")=="true")
		$('#leak_override').prop('checked',true).checkboxradio( "refresh" );
	if(localStorage.getItem("expansion_port_<?php echo $_GET['port']; ?>_lightson_override")=="true")
		$('#lightson_override').prop('checked',true).checkboxradio( "refresh" );
	if(localStorage.getItem("LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>")!="" && localStorage.getItem("LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>")!=null) $("#LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>").val(localStorage.getItem("LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>"));
...
<div id="main" class="split split-horizontal">
    ...
    <h2>Expansion Relay Box <?php echo $_GET['box']; ?> - Port <?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?></h2>
    <p>Choose which function you would like to assign for Port <?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?> of your expansion relay box <?php echo $_GET['box']; ?>:</p>
    <div>
        ...
        <p>
            <label for="LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>">Box <?php echo $_GET['box']; ?> - Port <?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?> Label: </label>
            <input type="text" id="LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>" name="LABEL_PORT<?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>" value="Port <?php echo $_GET['box']; ?><?php if ($_GET['port']>10) echo $_GET['port']-10; else echo $_GET['port'];?>">
		</p>        
        <fieldset>
